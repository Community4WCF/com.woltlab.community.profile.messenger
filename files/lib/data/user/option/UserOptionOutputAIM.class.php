...
/*
 * Implements an AIM Profilefield
 * @svn			$Id: UserOptionOutputAIM.class.php 1417 2010-05-13 18:26:15Z TobiasH87 $
 * @package		com.woltlab.community.profile.messenger
*/
 
class UserOptionOutputAIM implements UserOptionOutput, UserOptionOutputContactInformation {
	protected $type = 'aim';
	...
	*/
	...
	public function getOutputData(User $user, $optionData, $value) {
		...
		return array(
			...
			'url' => 'aim:'.StringUtil::encodeHTML($value)
		);
	}
	...
	*/
	...
	protected function getLink(User $user, $title, $value) {
		return '<a href="aim:'.StringUtil::encodeHTML($value).'">'.$title.'</a>';
	}
}
?>