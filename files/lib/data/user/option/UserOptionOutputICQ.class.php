...
/*
 * Implements an ICQ Profilefield
 * @svn			$Id: UserOptionOutputICQ.class.php 1417 2010-05-13 18:26:15Z TobiasH87 $
...
class UserOptionOutputICQ implements UserOptionOutput, UserOptionOutputContactInformation {
	...
	*/
	...
	public function getOutputData(User $user, $optionData, $value) {
		...
		return array(
			...
			'url' => 'http://www.icq.com/people/about_me.php?uin='.StringUtil::encodeHTML($value)
		);
	}
	...
	*/
	...
	protected function getLink(User $user, $title, $value) {
		return '<a href="http://www.icq.com/people/about_me.php?uin='.StringUtil::encodeHTML($value).'">'.$title.'</a>';
	}
}
?>