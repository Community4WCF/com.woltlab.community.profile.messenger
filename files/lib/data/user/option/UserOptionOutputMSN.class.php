...
/*
 * Implements an MSN Profilefield
 * @svn			$Id: UserOptionOutputMSN.class.php 1417 2010-05-13 18:26:15Z TobiasH87 $
 * @package		com.woltlab.community.profile.messenger
*/
 
class UserOptionOutputMSN implements UserOptionOutput, UserOptionOutputContactInformation {
	protected $type = 'msn';
	...
	*/
	...
	public function getOutputData(User $user, $optionData, $value) {
		...
		return array(
			...
			'url' => 'http://members.msn.com/'.StringUtil::encodeHTML($value)
		);
	}
	...
	*/
	...
	protected function getLink(User $user, $title, $value) {
		return '<a href="http://members.msn.com/'.StringUtil::encodeHTML($value).'">'.$title.'</a>';
	}
}
?>