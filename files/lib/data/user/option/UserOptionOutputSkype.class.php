...
/*
 * Implements an Skype Profilefield
 * @svn			$Id: UserOptionOutputSkype.class.php 1417 2010-05-13 18:26:15Z TobiasH87 $
 * @package		com.woltlab.community.profile.messenger
*/
 
class UserOptionOutputSkype implements UserOptionOutput, UserOptionOutputContactInformation {
	...
	*/
	...
	public function getOutputData(User $user, $optionData, $value) {
		...
		return array(
			...
			'url' => 'skype:'.StringUtil::encodeHTML($value)
		);
	}
	...
	*/
	...
	protected function getLink(User $user, $title, $value) {
		return '<a href="skype:'.StringUtil::encodeHTML($value).'">'.$title.'</a>';
	}
}
?>