...
/*
 * Implements an IRC Profilefield
 * @svn			$Id: UserOptionOutputIRC.class.php 1417 2010-05-13 18:26:15Z TobiasH87 $
 * @package		com.woltlab.community.profile.irc
*/
 
class UserOptionOutputIRC implements UserOptionOutput, UserOptionOutputContactInformation {
	protected $type = 'irc';
	...
	*/
	...
	public function getOutputData(User $user, $optionData, $value) {
		...
		return array(
			...
			'url' => 'irc://'.StringUtil::encodeHTML($value)
		);
	}
	...
	*/
	...
	protected function getLink(User $user, $title, $value) {
		return '<a href="irc://'.StringUtil::encodeHTML($value).'">'.$title.'</a>';
	}
}
?>