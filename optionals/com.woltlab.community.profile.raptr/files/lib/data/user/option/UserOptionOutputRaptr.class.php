...
/*
 * Implements an Raptr Profilefield
 * @package		com.woltlab.community.profile.raptr
*/
 
class UserOptionOutputRaptr implements UserOptionOutput, UserOptionOutputContactInformation {
	protected $type = 'raptr';
	
	/*
	 * getURL from Options
	 */
	public function getURL() {
		return $url = 'http://raptr.com/';
	}
